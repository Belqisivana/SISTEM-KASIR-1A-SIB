...
public class SistemKasir {
    ...
    static String beliLagi, member, tgl, namaKasir, namaPelanggan, inputNamaBarang, targetBarang, namaBarangBaru, cariIndexBarang, dateFormatetted, s;
    static int jmlBarang = 0, totalBayar = 0, stokBarangBaru, tambahStokBarang, sokBarang =  0, metodePembayaran, hargaBarangBaru, menu;
