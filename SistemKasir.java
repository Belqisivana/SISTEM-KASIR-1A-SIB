...
public class SistemKasir {
    ...
    static String beliLagi, member, namaKasir, namaPelanggan, inputNamaBarang, targetBarang, namaBarangBaru, cariIndexBarang, SimpleDateFormat, s,  dateFormatetted, masukkanUsername, masukkanPassword;
    static int jmlBarang = 0, totalBayar = 0, stokBarangBaru, tambahStokBarang, metodePembayaran, hargaBarangBaru, menu, menuManager;
...
// Login kasir
    while (!berhasilMasuk) {
        ...
        for (int x = 0; x < username.length;x++) {
            if (masukkanUsername.equalsIgnoreCase(username[x])&& masukkanPassword.equals(password[x])) {
                i = x;
                System.out.println("============================");
    ...
    if (isManager) {
        ...
        // Fungsi Transaksi
            ...
            System.out.println("Kasir: " + username[i]);
            ...
            while (beliBarang) {
                ...
                if (index != -1) {
                    ...
                    if(jmlBarang > stokBarang[index]){
                        System.out.println("Tidak bisa terbeli, Stok Barang Tersisa : " + stokBarang[index]);
                        break;
                    }else
            ...
            if (member.equals("ya")) {
                ...
                if ( yangDibayarkan < bayar) {
                    System.out.println("Uang anda tidak mencukupi. Silahkan masukkan jumlah uang yang mencukupi");
                }
